...
@export var enemies : Array[CombatentResource]
@export var extra_loot : Array[LootResource]
@export var is_override_enemy_loot : bool

# Idealy a separate alie resource so that we can configure things like:
# - Can Player Controll
...
@export var alies : Array[CombatentResource]
